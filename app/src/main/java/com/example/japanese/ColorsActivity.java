...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wordsList.add(new Word("red", "あか", "赤", R.raw.aka, R.drawable.color_red));
        wordsList.add(new Word("green", "みどり", "緑", R.raw.midori, R.drawable.color_green));
        wordsList.add(new Word("brown", "ちゃいろ", "茶色", R.raw.chairo, R.drawable.color_brown));
        wordsList.add(new Word("gray", "グレー", "グレー", R.raw.grey, R.drawable.color_gray));
        wordsList.add(new Word("black", "くろ", "黒", R.raw.kuro, R.drawable.color_black));
        wordsList.add(new Word("white", "しろ", "白", R.raw.shiro, R.drawable.color_white));
        wordsList.add(new Word("yellow", "きいろ", "黄色", R.raw.kiiro, R.drawable.color_dusty_yellow));
        wordsList.add(new Word("blue", "あお", "青", R.raw.aoi));

        WordAdapter  adapter = new WordAdapter(this, wordsList, R.color.category_colors);
